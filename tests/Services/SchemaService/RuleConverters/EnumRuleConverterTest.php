...
class EnumRuleConverterTest extends RuleConverterTestCase
{
    ...
    public static function casesProvider(): array
    {
        return [
            [
                 [new Enum(IntegerEnum::class)],
                 TestSchema::make()->set('type', 'integer')->set('enum', array_column(IntegerEnum::cases(), 'value')),
            ],
            [
                 [new Enum(StringEnum::class)],
                 TestSchema::make()->set('type', 'string')->set('enum', array_column(StringEnum::cases(), 'value')),
            ]
        ];
    }
}