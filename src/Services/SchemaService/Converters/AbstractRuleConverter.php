...
abstract class AbstractRuleConverter
{
     ...
     * @return array
     */
    public static function run(array $schema, string $path, array $rules, SchemaType $schemaType): array
    {
        $rule = new static($schema, $path, $rules, $schemaType);
        $rule->handle();
    ...
    {
        return strtolower($this->getField('type'));
    }
